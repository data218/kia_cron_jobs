...
function enrichDataset(merged, fallbackDealerCode = 'N5701') {
  const value = String(fallbackDealerCode || 'N5701').trim().toUpperCase();
...
async function main() {
  console.log('\n===============================================================');
  console.log('  HYUNDAI SALES REPORT - HISTORICAL FETCH (AKHNOOR - N5701)');
  console.log('===============================================================');
  ...
  try {
    ...
    console.log('\n===============================================================');
    console.log('  HISTORICAL FETCH COMPLETE (AKHNOOR - N5701)');
    console.log('===============================================================');
    console.log(`  Dealer Code      : ${DEALER_CODE}`);

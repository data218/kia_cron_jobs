#!/usr/bin/env node
// Kathua (N5804) Remaining Sales Report Fetcher (July 2019 -> June 2026)
// Login: N580400 / Kathua@321 | Dealer: N5804 (Preserves active portal dealer)
...
const USER_ID = getArg('user', 'N580400');
const PASSWORD = getArg('password', 'Kathua@321');
const DEALER_CODE = getArg('dealer', 'N5804').toUpperCase();
const START_DATE = getArg('start', '2019-07-01');
...
async function main() {
  console.log('===============================================================');
  console.log('  HYUNDAI SALES REPORT - KATHUA (N5804) REMAINING RUNNER');
  console.log('===============================================================');
  ...
  const downloadDir = path.resolve(`./downloads/hmil-kathua-sales`);
  ...
  try {
    ...
    console.log('\n===============================================================');
    console.log(`🎉 COMPLETED ALL CHUNKS FOR KATHUA (${DEALER_CODE})`);

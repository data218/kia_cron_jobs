...
const START_DATE = getArg('start', '2015-01-01');
...
async function main() {
  console.log('\n===============================================================');
  console.log('  HYUNDAI SALES REPORT - HISTORICAL FETCH (KATHUA - N5804)');
  console.log('===============================================================');
  ...
  try {
    ...
    console.log('\n===============================================================');
    console.log('  HISTORICAL FETCH COMPLETE (KATHUA - N5804)');
    console.log('===============================================================');
    console.log(`  Dealer Code      : ${DEALER_CODE}`);

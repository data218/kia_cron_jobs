#!/usr/bin/env node
// Greater Jammu (N6826) Remaining Sales Report Fetcher (Feb 2026 -> June 2026)
// Login: N682600 / Jammu@6826 | Dealer: N6826 (Preserves active portal dealer)
...
const USER_ID = getArg('user', 'N682600');
const PASSWORD = getArg('password', 'Jammu@6826');
const DEALER_CODE = getArg('dealer', 'N6826').toUpperCase();
const START_DATE = getArg('start', '2026-01-01');
...
async function main() {
  console.log('===============================================================');
  console.log('  HYUNDAI SALES REPORT - GREATER JAMMU (N6826) REMAINING RUNNER');
  console.log('===============================================================');
  ...
  const downloadDir = path.resolve(`./downloads/hmil-n6826-sales`);
  ...
  try {
    ...
    console.log('\n===============================================================');
    console.log(`🎉 COMPLETED ALL CHUNKS FOR GREATER JAMMU (${DEALER_CODE})`);
